...
/**
 * RepeatedInterval implements a vector with multple values per row (e.g. JSON array or
...
public final class RepeatedIntervalVector extends BaseRepeatedValueVector implements RepeatedFixedWidthVectorLike {
  //private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(RepeatedIntervalVector.class);

  // we maintain local reference to concrete vector type for performance reasons.
  private IntervalVector values;
  private final FieldReader reader = new RepeatedIntervalReaderImpl(RepeatedIntervalVector.this);
  ...
  public AddOrGetResult<IntervalVector> addOrGetVector(VectorDescriptor descriptor) {
    final AddOrGetResult<IntervalVector> result = super.addOrGetVector(descriptor);
    if (result.isCreated()) {
  ...
  public void splitAndTransferTo(final int startIndex, final int groups, RepeatedIntervalVector to) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, RepeatedIntervalVector.this);
    }
  }
  ...
  public final class Accessor extends BaseRepeatedValueVector.BaseRepeatedAccessor {
    ...
    public List<Period> getObject(int index) {
      ...
      final IntervalVector.Accessor valuesAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseRepeatedValueVector.BaseRepeatedMutator implements RepeatedMutator {
    ...
    public void setSafe(int index, RepeatedIntervalHolder h) {
      final IntervalHolder ih = new IntervalHolder();
      final IntervalVector.Accessor hVectorAccessor = h.vector.getAccessor();
    ...
    public void addSafe(int arrayIndex, int months, int days, int milliseconds) {
      ...
      values.getMutator().setSafe(nextOffset, months, days, milliseconds);
