...
public class RepeatedUInt8HolderReaderImpl extends AbstractFieldReader {

  private NullableUInt8Holder holder;
  private int index = -1;
  private RepeatedUInt8Holder repeatedHolder;

  public RepeatedUInt8HolderReaderImpl(RepeatedUInt8Holder holder) {
