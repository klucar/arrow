...
/**
 * RepeatedDecimal18 implements a vector with multple values per row (e.g. JSON array or
...
public final class RepeatedDecimal18Vector extends BaseRepeatedValueVector implements RepeatedFixedWidthVectorLike {
  //private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(RepeatedDecimal18Vector.class);

  // we maintain local reference to concrete vector type for performance reasons.
  private Decimal18Vector values;
  private final FieldReader reader = new RepeatedDecimal18ReaderImpl(RepeatedDecimal18Vector.this);
  ...
  public AddOrGetResult<Decimal18Vector> addOrGetVector(VectorDescriptor descriptor) {
    final AddOrGetResult<Decimal18Vector> result = super.addOrGetVector(descriptor);
    if (result.isCreated()) {
  ...
  public void splitAndTransferTo(final int startIndex, final int groups, RepeatedDecimal18Vector to) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, RepeatedDecimal18Vector.this);
    }
  }
  ...
  public final class Accessor extends BaseRepeatedValueVector.BaseRepeatedAccessor {
    ...
    public List<BigDecimal> getObject(int index) {
      ...
      final Decimal18Vector.Accessor valuesAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseRepeatedValueVector.BaseRepeatedMutator implements RepeatedMutator {
    ...
    public void setSafe(int index, RepeatedDecimal18Holder h) {
      final Decimal18Holder ih = new Decimal18Holder();
      final Decimal18Vector.Accessor hVectorAccessor = h.vector.getAccessor();
