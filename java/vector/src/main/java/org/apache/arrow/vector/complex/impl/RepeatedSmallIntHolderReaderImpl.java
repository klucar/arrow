...
public class RepeatedSmallIntHolderReaderImpl extends AbstractFieldReader {

  private NullableSmallIntHolder holder;
  private int index = -1;
  private RepeatedSmallIntHolder repeatedHolder;

  public RepeatedSmallIntHolderReaderImpl(RepeatedSmallIntHolder holder) {
