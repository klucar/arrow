...
/**
 * NullableFloat4 implements a vector of values which could be null.  Elements in the vector
...
public final class NullableFloat4Vector extends BaseDataValueVector implements FixedWidthVector, NullableVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NullableFloat4Vector.class);

  private final FieldReader reader = new NullableFloat4ReaderImpl(NullableFloat4Vector.this);
  ...
  private final Float4Vector values = new Float4Vector(field, allocator);
  ...
  @Override
  public Float4Vector getValuesVector() {
    return values;
  }
...
//  }
  ...
  public void splitAndTransferTo(int startIndex, int length, NullableFloat4Vector target) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new NullableFloat4Vector(field, allocator);
    }
  ...
  public Float4Vector convertToRequiredVector(){
    Float4Vector v = new Float4Vector(getField().getOtherNullableVersion(), allocator);
    if (v.data != null) {
      v.data.release(1);
    }
    v.data = values.data;
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor  {
    ...
    final Float4Vector.Accessor vAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseDataValueVector.BaseMutator implements NullableVectorDefinitionSetter {
    ...
    public Float4Vector getVectorWithValues(){
      return values;
    }
    ...
    public void set(int index, float value) {
      setCount++;
      final Float4Vector.Mutator valuesMutator = values.getMutator();
    ...
    public void setSkipNull(int index, Float4Holder holder){
      values.getMutator().set(index, holder);
    }

    public void setSkipNull(int index, NullableFloat4Holder holder){
      values.getMutator().set(index, holder);
    }


    public void set(int index, NullableFloat4Holder holder){
      final Float4Vector.Mutator valuesMutator = values.getMutator();
    ...
    public boolean isSafe(int outIndex) {
      return outIndex < NullableFloat4Vector.this.getValueCapacity();
    }
    ...
    public void setSafe(int index, NullableFloat4Holder value) {
    ...
    public void setSafe(int index, Float4Holder value) {
