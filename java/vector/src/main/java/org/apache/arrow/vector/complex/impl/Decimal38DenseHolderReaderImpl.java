...
public class Decimal38DenseHolderReaderImpl extends AbstractFieldReader {

  private Decimal38DenseHolder holder;

  public Decimal38DenseHolderReaderImpl(Decimal38DenseHolder holder) {
    this.holder = holder;
  }
