...
public class RepeatedDecimal28SparseReaderImpl extends AbstractFieldReader {
  ...
  public RepeatedDecimal28SparseReaderImpl(RepeatedDecimal28SparseVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(Decimal28SparseWriter writer){
    RepeatedDecimal28SparseWriterImpl impl = (RepeatedDecimal28SparseWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    RepeatedDecimal28SparseWriterImpl impl = (RepeatedDecimal28SparseWriterImpl)  writer.list(name).decimal28Sparse();
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  ...
  public void read(int arrayIndex, Decimal28SparseHolder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
  public void read(int arrayIndex, NullableDecimal28SparseHolder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
