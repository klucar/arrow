...
/**
 * NullableTime implements a vector of values which could be null.  Elements in the vector
...
public final class NullableTimeVector extends BaseDataValueVector implements FixedWidthVector, NullableVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NullableTimeVector.class);

  private final FieldReader reader = new NullableTimeReaderImpl(NullableTimeVector.this);
  ...
  private final TimeVector values = new TimeVector(field, allocator);
...
//  }
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new NullableTimeVector(field, allocator);
    }
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, NullableTimeVector.this);
    }
  }
  ...
  public TimeVector convertToRequiredVector(){
    TimeVector v = new TimeVector(getField().getOtherNullableVersion(), allocator);
    if (v.data != null) {
      v.data.release(1);
    }
    v.data = values.data;
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor  {
    ...
    final TimeVector.Accessor vAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseDataValueVector.BaseMutator implements NullableVectorDefinitionSetter {
    ...
    public void set(int index, int value) {
      setCount++;
      final TimeVector.Mutator valuesMutator = values.getMutator();
