...
public class NullableDecimal38DenseReaderImpl extends AbstractFieldReader {
  ...
  public NullableDecimal38DenseReaderImpl(NullableDecimal38DenseVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(Decimal38DenseWriter writer){
    NullableDecimal38DenseWriterImpl impl = (NullableDecimal38DenseWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    NullableDecimal38DenseWriterImpl impl = (NullableDecimal38DenseWriterImpl) writer.decimal38Dense(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
