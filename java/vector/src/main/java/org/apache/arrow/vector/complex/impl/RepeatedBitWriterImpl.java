...
public class RepeatedBitWriterImpl extends AbstractFieldWriter {

  private final RepeatedBitVector.Mutator mutator;
  final RepeatedBitVector vector;

  public RepeatedBitWriterImpl(RepeatedBitVector vector, AbstractFieldWriter parent) {
    super(parent);
