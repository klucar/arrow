...
public class NullableVarBinaryWriterImpl extends AbstractFieldWriter {

  private final NullableVarBinaryVector.Mutator mutator;
  final NullableVarBinaryVector vector;

  public NullableVarBinaryWriterImpl(NullableVarBinaryVector vector, AbstractFieldWriter parent) {
    super(parent);
