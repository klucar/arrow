...
public class NullableIntervalDayWriterImpl extends AbstractFieldWriter {
  ...
  private final NullableIntervalDayVector.Mutator mutator;
  final NullableIntervalDayVector vector;

  public NullableIntervalDayWriterImpl(NullableIntervalDayVector vector, AbstractFieldWriter parent) {
    super(parent);
  ...
  public void writeIntervalDay(int days, int milliseconds) {
    mutator.setSafe(idx(), 1, days, milliseconds);
    vector.getMutator().setValueCount(idx()+1);
  }
