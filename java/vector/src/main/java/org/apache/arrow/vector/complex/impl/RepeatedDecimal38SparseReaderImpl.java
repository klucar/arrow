...
public class RepeatedDecimal38SparseReaderImpl extends AbstractFieldReader {
  ...
  public RepeatedDecimal38SparseReaderImpl(RepeatedDecimal38SparseVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void read(int arrayIndex, Decimal38SparseHolder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
  public void read(int arrayIndex, NullableDecimal38SparseHolder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
