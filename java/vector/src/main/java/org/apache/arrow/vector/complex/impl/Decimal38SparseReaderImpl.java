...
public class Decimal38SparseReaderImpl extends AbstractFieldReader {
  
  private final Decimal38SparseVector vector;
  
  public Decimal38SparseReaderImpl(Decimal38SparseVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(Decimal38SparseWriter writer){
    Decimal38SparseWriterImpl impl = (Decimal38SparseWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    Decimal38SparseWriterImpl impl = (Decimal38SparseWriterImpl) writer.decimal38Sparse(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
