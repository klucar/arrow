...
/**
 * BigInt implements a vector of fixed width values.  Elements in the vector are accessed
...
public final class BigIntVector extends BaseDataValueVector implements FixedWidthVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(BigIntVector.class);

  private final FieldReader reader = new BigIntReaderImpl(BigIntVector.this);
...
//    }
 ...
 /**
  * BigInt.Mutator implements a mutable vector of fixed width values.  Elements in the
