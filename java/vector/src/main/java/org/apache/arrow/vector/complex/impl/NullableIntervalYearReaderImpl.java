...
public class NullableIntervalYearReaderImpl extends AbstractFieldReader {
  ...
  public NullableIntervalYearReaderImpl(NullableIntervalYearVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(IntervalYearWriter writer){
    NullableIntervalYearWriterImpl impl = (NullableIntervalYearWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    NullableIntervalYearWriterImpl impl = (NullableIntervalYearWriterImpl) writer.intervalYear(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
