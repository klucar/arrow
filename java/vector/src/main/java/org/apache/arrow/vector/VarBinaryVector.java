...
/**
 * VarBinaryVector implements a vector of variable width values.  Elements in the vector
...
public final class VarBinaryVector extends BaseDataValueVector implements VariableWidthVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(VarBinaryVector.class);
  ...
  private final FieldReader reader = new VarBinaryReaderImpl(VarBinaryVector.this);
