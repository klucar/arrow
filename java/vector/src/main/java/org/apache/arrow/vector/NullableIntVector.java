...
/**
 * NullableInt implements a vector of values which could be null.  Elements in the vector
...
public final class NullableIntVector extends BaseDataValueVector implements FixedWidthVector, NullableVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NullableIntVector.class);

  private final FieldReader reader = new NullableIntReaderImpl(NullableIntVector.this);
  ...
  public NullableIntVector(MaterializedField field, BufferAllocator allocator) {
  ...
  @Override
  public IntVector getValuesVector() {
    return values;
  }
...
//  }
  ...
  public void transferTo(NullableIntVector target){
    bits.transferTo(target.bits);
    values.transferTo(target.values);
    clear();
  }

  public void splitAndTransferTo(int startIndex, int length, NullableIntVector target) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new NullableIntVector(field, allocator);
    }
  ...
  public IntVector convertToRequiredVector(){
    IntVector v = new IntVector(getField().getOtherNullableVersion(), allocator);
    if (v.data != null) {
      v.data.release(1);
    }
    v.data = values.data;
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor  {
    ...
    final IntVector.Accessor vAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseDataValueVector.BaseMutator implements NullableVectorDefinitionSetter {
    ...
    public void set(int index, int value) {
      setCount++;
      final IntVector.Mutator valuesMutator = values.getMutator();
    ...
    public boolean isSafe(int outIndex) {
      return outIndex < NullableIntVector.this.getValueCapacity();
    }
