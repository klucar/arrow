...
public class NullableBigIntReaderImpl extends AbstractFieldReader {
  
  private final NullableBigIntVector vector;
  
  public NullableBigIntReaderImpl(NullableBigIntVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(BigIntWriter writer){
    NullableBigIntWriterImpl impl = (NullableBigIntWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    NullableBigIntWriterImpl impl = (NullableBigIntWriterImpl) writer.bigInt(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
