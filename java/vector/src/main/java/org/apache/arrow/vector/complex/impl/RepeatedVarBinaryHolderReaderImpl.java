...
public class RepeatedVarBinaryHolderReaderImpl extends AbstractFieldReader {

  private NullableVarBinaryHolder holder;
  private int index = -1;
  private RepeatedVarBinaryHolder repeatedHolder;

  public RepeatedVarBinaryHolderReaderImpl(RepeatedVarBinaryHolder holder) {
