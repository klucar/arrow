...
/**
 * RepeatedIntervalYear implements a vector with multple values per row (e.g. JSON array or
...
public final class RepeatedIntervalYearVector extends BaseRepeatedValueVector implements RepeatedFixedWidthVectorLike {
  //private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(RepeatedIntervalYearVector.class);

  // we maintain local reference to concrete vector type for performance reasons.
  private IntervalYearVector values;
  private final FieldReader reader = new RepeatedIntervalYearReaderImpl(RepeatedIntervalYearVector.this);
  ...
  public AddOrGetResult<IntervalYearVector> addOrGetVector(VectorDescriptor descriptor) {
    final AddOrGetResult<IntervalYearVector> result = super.addOrGetVector(descriptor);
    if (result.isCreated()) {
  ...
  public void splitAndTransferTo(final int startIndex, final int groups, RepeatedIntervalYearVector to) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, RepeatedIntervalYearVector.this);
    }
  }
  ...
  public final class Accessor extends BaseRepeatedValueVector.BaseRepeatedAccessor {
    ...
    public List<Period> getObject(int index) {
      ...
      final IntervalYearVector.Accessor valuesAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseRepeatedValueVector.BaseRepeatedMutator implements RepeatedMutator {
    ...
    public void setSafe(int index, RepeatedIntervalYearHolder h) {
      final IntervalYearHolder ih = new IntervalYearHolder();
      final IntervalYearVector.Accessor hVectorAccessor = h.vector.getAccessor();
