...
/**
 * RepeatedDecimal28Dense implements a vector with multple values per row (e.g. JSON array or
...
public final class RepeatedDecimal28DenseVector extends BaseRepeatedValueVector implements RepeatedFixedWidthVectorLike {
  //private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(RepeatedDecimal28DenseVector.class);

  // we maintain local reference to concrete vector type for performance reasons.
  private Decimal28DenseVector values;
  private final FieldReader reader = new RepeatedDecimal28DenseReaderImpl(RepeatedDecimal28DenseVector.this);
  ...
  public AddOrGetResult<Decimal28DenseVector> addOrGetVector(VectorDescriptor descriptor) {
    final AddOrGetResult<Decimal28DenseVector> result = super.addOrGetVector(descriptor);
    if (result.isCreated()) {
  ...
  public void splitAndTransferTo(final int startIndex, final int groups, RepeatedDecimal28DenseVector to) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, RepeatedDecimal28DenseVector.this);
    }
  }
  ...
  public final class Accessor extends BaseRepeatedValueVector.BaseRepeatedAccessor {
    ...
    public List<BigDecimal> getObject(int index) {
      ...
      final Decimal28DenseVector.Accessor valuesAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseRepeatedValueVector.BaseRepeatedMutator implements RepeatedMutator {
    ...
    public void setSafe(int index, RepeatedDecimal28DenseHolder h) {
      final Decimal28DenseHolder ih = new Decimal28DenseHolder();
      final Decimal28DenseVector.Accessor hVectorAccessor = h.vector.getAccessor();
