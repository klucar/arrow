...
/**
 * NullableDecimal9 implements a vector of values which could be null.  Elements in the vector
...
public final class NullableDecimal9Vector extends BaseDataValueVector implements FixedWidthVector, NullableVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NullableDecimal9Vector.class);

  private final FieldReader reader = new NullableDecimal9ReaderImpl(NullableDecimal9Vector.this);
  ...
  private final Decimal9Vector values = new Decimal9Vector(field, allocator);

  private final Mutator mutator = new Mutator();
  private final Accessor accessor = new Accessor();

  public NullableDecimal9Vector(MaterializedField field, BufferAllocator allocator) {
  ...
  @Override
  public Decimal9Vector getValuesVector() {
    return values;
  }
...
//  }
  ...
  public TransferPair makeTransferPair(ValueVector to) {
    return new TransferImpl((NullableDecimal9Vector) to);
  }

  public void transferTo(NullableDecimal9Vector target){
    bits.transferTo(target.bits);
    values.transferTo(target.values);
    clear();
  }

  public void splitAndTransferTo(int startIndex, int length, NullableDecimal9Vector target) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new NullableDecimal9Vector(field, allocator);
    }

    public TransferImpl(NullableDecimal9Vector to){
      this.to = to;
    }

    @Override
    public NullableDecimal9Vector getTo(){
      return to;
    }
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, NullableDecimal9Vector.this);
    }
  }
  ...
  public Decimal9Vector convertToRequiredVector(){
    Decimal9Vector v = new Decimal9Vector(getField().getOtherNullableVersion(), allocator);
    if (v.data != null) {
      v.data.release(1);
    }
    v.data = values.data;
  ...
  public void copyFrom(int fromIndex, int thisIndex, NullableDecimal9Vector from){
  ...
  public void copyFromSafe(int fromIndex, int thisIndex, NullableDecimal9Vector from){
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor  {
    ...
    final Decimal9Vector.Accessor vAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseDataValueVector.BaseMutator implements NullableVectorDefinitionSetter {
    ...
    public void set(int index, int value) {
      setCount++;
      final Decimal9Vector.Mutator valuesMutator = values.getMutator();
    ...
    public void setSkipNull(int index, Decimal9Holder holder){
      values.getMutator().set(index, holder);
    }

    public void setSkipNull(int index, NullableDecimal9Holder holder){
      values.getMutator().set(index, holder);
    }


    public void set(int index, NullableDecimal9Holder holder){
      final Decimal9Vector.Mutator valuesMutator = values.getMutator();
    ...
    public void set(int index, Decimal9Holder holder){
      final Decimal9Vector.Mutator valuesMutator = values.getMutator();
      bits.getMutator().set(index, 1);
      valuesMutator.set(index, holder);
    ...
    public boolean isSafe(int outIndex) {
      return outIndex < NullableDecimal9Vector.this.getValueCapacity();
    }
    ...
    public void setSafe(int index, NullableDecimal9Holder value) {
    ...
    public void setSafe(int index, Decimal9Holder value) {
