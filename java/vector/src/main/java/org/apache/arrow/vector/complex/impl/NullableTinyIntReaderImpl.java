...
public class NullableTinyIntReaderImpl extends AbstractFieldReader {
  ...
  public void copyAsValue(TinyIntWriter writer){
    NullableTinyIntWriterImpl impl = (NullableTinyIntWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    NullableTinyIntWriterImpl impl = (NullableTinyIntWriterImpl) writer.tinyInt(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
