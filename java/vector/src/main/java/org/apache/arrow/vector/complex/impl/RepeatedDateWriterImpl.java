...
public class RepeatedDateWriterImpl extends AbstractFieldWriter {

  private final RepeatedDateVector.Mutator mutator;
  final RepeatedDateVector vector;

  public RepeatedDateWriterImpl(RepeatedDateVector vector, AbstractFieldWriter parent) {
    super(parent);
