...
public class RepeatedUInt2HolderReaderImpl extends AbstractFieldReader {

  private NullableUInt2Holder holder;
  private int index = -1;
  private RepeatedUInt2Holder repeatedHolder;

  public RepeatedUInt2HolderReaderImpl(RepeatedUInt2Holder holder) {
  ...
  @Override
  public Character readCharacter(int index){
    repeatedHolder.vector.getAccessor().get(repeatedHolder.start + index, holder);
    Character value = readCharacter();
    if (this.index > -1) {
