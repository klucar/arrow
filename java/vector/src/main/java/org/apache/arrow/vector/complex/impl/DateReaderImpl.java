...
public class DateReaderImpl extends AbstractFieldReader {
  ...
  public void copyAsValue(DateWriter writer){
    DateWriterImpl impl = (DateWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    DateWriterImpl impl = (DateWriterImpl) writer.date(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }

  public void read(DateHolder h){
