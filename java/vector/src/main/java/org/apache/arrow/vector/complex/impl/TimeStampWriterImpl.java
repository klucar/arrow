...
public class TimeStampWriterImpl extends AbstractFieldWriter {

  private final TimeStampVector.Mutator mutator;
  final TimeStampVector vector;

  public TimeStampWriterImpl(TimeStampVector vector, AbstractFieldWriter parent) {
    super(parent);
