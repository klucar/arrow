...
public class NullableDecimal28DenseHolderReaderImpl extends AbstractFieldReader {

  private NullableDecimal28DenseHolder holder;

  public NullableDecimal28DenseHolderReaderImpl(NullableDecimal28DenseHolder holder) {
    this.holder = holder;
  }
