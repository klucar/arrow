...
public class RepeatedTinyIntHolderReaderImpl extends AbstractFieldReader {

  private NullableTinyIntHolder holder;
  private int index = -1;
  private RepeatedTinyIntHolder repeatedHolder;

  public RepeatedTinyIntHolderReaderImpl(RepeatedTinyIntHolder holder) {
