...
/**
 * NullableBit implements a vector of values which could be null.  Elements in the vector
...
public final class NullableBitVector extends BaseDataValueVector implements FixedWidthVector, NullableVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NullableBitVector.class);

  private final FieldReader reader = new NullableBitReaderImpl(NullableBitVector.this);
  ...
  private final BitVector values = new BitVector(field, allocator);

  private final Mutator mutator = new Mutator();
  private final Accessor accessor = new Accessor();

  public NullableBitVector(MaterializedField field, BufferAllocator allocator) {
  ...
  @Override
  public BitVector getValuesVector() {
    return values;
  }
...
//  }
  ...
  public void transferTo(NullableBitVector target){
    bits.transferTo(target.bits);
    values.transferTo(target.values);
    clear();
  }

  public void splitAndTransferTo(int startIndex, int length, NullableBitVector target) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new NullableBitVector(field, allocator);
    }
  ...
  public BitVector convertToRequiredVector(){
    BitVector v = new BitVector(getField().getOtherNullableVersion(), allocator);
    if (v.data != null) {
      v.data.release(1);
    }
    v.data = values.data;
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor  {
    ...
    final BitVector.Accessor vAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseDataValueVector.BaseMutator implements NullableVectorDefinitionSetter {
    ...
    public BitVector getVectorWithValues(){
      return values;
    }
    ...
    public void set(int index, int value) {
      setCount++;
      final BitVector.Mutator valuesMutator = values.getMutator();
    ...
    public void setSkipNull(int index, BitHolder holder){
      values.getMutator().set(index, holder);
    }

    public void setSkipNull(int index, NullableBitHolder holder){
      values.getMutator().set(index, holder);
    }


    public void set(int index, NullableBitHolder holder){
      final BitVector.Mutator valuesMutator = values.getMutator();
    ...
    public boolean isSafe(int outIndex) {
      return outIndex < NullableBitVector.this.getValueCapacity();
    }
    ...
    public void setSafe(int index, NullableBitHolder value) {
    ...
    public void setSafe(int index, BitHolder value) {
