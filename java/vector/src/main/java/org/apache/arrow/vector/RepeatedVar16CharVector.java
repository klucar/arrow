...
/**
 * RepeatedVar16Char implements a vector with multple values per row (e.g. JSON array or
...
public final class RepeatedVar16CharVector extends BaseRepeatedValueVector implements RepeatedVariableWidthVectorLike {
  //private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(RepeatedVar16CharVector.class);

  // we maintain local reference to concrete vector type for performance reasons.
  private Var16CharVector values;
  private final FieldReader reader = new RepeatedVar16CharReaderImpl(RepeatedVar16CharVector.this);
  ...
  public AddOrGetResult<Var16CharVector> addOrGetVector(VectorDescriptor descriptor) {
    final AddOrGetResult<Var16CharVector> result = super.addOrGetVector(descriptor);
    if (result.isCreated()) {
  ...
  public void splitAndTransferTo(final int startIndex, final int groups, RepeatedVar16CharVector to) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, RepeatedVar16CharVector.this);
    }
  }
...
//  }
  ...
  public final class Accessor extends BaseRepeatedValueVector.BaseRepeatedAccessor {
    ...
    public List<String> getObject(int index) {
      final List<String> vals = new JsonStringArrayList<>();
      ...
      final Var16CharVector.Accessor valuesAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseRepeatedValueVector.BaseRepeatedMutator implements RepeatedMutator {
    ...
    public void setSafe(int index, RepeatedVar16CharHolder h) {
      final Var16CharHolder ih = new Var16CharHolder();
      final Var16CharVector.Accessor hVectorAccessor = h.vector.getAccessor();
