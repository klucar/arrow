...
public final class NullableVar16CharHolder implements ValueHolder{
  
  public static final MajorType TYPE = new MajorType(MinorType.VAR16CHAR, DataMode.OPTIONAL);
