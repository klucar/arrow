...
public class NullableIntervalReaderImpl extends AbstractFieldReader {
  ...
  public NullableIntervalReaderImpl(NullableIntervalVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(IntervalWriter writer){
    NullableIntervalWriterImpl impl = (NullableIntervalWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    NullableIntervalWriterImpl impl = (NullableIntervalWriterImpl) writer.interval(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
