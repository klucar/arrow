...
/**
 * RepeatedUInt1 implements a vector with multple values per row (e.g. JSON array or
...
public final class RepeatedUInt1Vector extends BaseRepeatedValueVector implements RepeatedFixedWidthVectorLike {
  //private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(RepeatedUInt1Vector.class);

  // we maintain local reference to concrete vector type for performance reasons.
  private UInt1Vector values;
  private final FieldReader reader = new RepeatedUInt1ReaderImpl(RepeatedUInt1Vector.this);
  ...
  public AddOrGetResult<UInt1Vector> addOrGetVector(VectorDescriptor descriptor) {
    final AddOrGetResult<UInt1Vector> result = super.addOrGetVector(descriptor);
    if (result.isCreated()) {
  ...
  public void splitAndTransferTo(final int startIndex, final int groups, RepeatedUInt1Vector to) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator) {
      this.to = new RepeatedUInt1Vector(field, allocator);
    }
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, RepeatedUInt1Vector.this);
    }
  }
  ...
  public final class Accessor extends BaseRepeatedValueVector.BaseRepeatedAccessor {
    ...
    public List<Byte> getObject(int index) {
      ...
      final UInt1Vector.Accessor valuesAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseRepeatedValueVector.BaseRepeatedMutator implements RepeatedMutator {
    ...
    public void setSafe(int index, RepeatedUInt1Holder h) {
      final UInt1Holder ih = new UInt1Holder();
      final UInt1Vector.Accessor hVectorAccessor = h.vector.getAccessor();
