...
public final class NullableDecimal38DenseHolder implements ValueHolder{
  
  public static final MajorType TYPE = new MajorType(MinorType.DECIMAL38DENSE, DataMode.OPTIONAL);
