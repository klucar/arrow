...
public class NullableUInt2ReaderImpl extends AbstractFieldReader {
  
  private final NullableUInt2Vector vector;
  
  public NullableUInt2ReaderImpl(NullableUInt2Vector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(UInt2Writer writer){
    NullableUInt2WriterImpl impl = (NullableUInt2WriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    NullableUInt2WriterImpl impl = (NullableUInt2WriterImpl) writer.uInt2(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
