 ...
 */
public final class IntervalYearVector extends BaseDataValueVector implements FixedWidthVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(IntervalYearVector.class);

  private final FieldReader reader = new IntervalYearReaderImpl(IntervalYearVector.this);
...
//    }
 ...
 /**
  * IntervalYear.Mutator implements a mutable vector of fixed width values.  Elements in the
