...
public class RepeatedDateReaderImpl extends AbstractFieldReader {
  ...
  public RepeatedDateReaderImpl(RepeatedDateVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(DateWriter writer){
    RepeatedDateWriterImpl impl = (RepeatedDateWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    RepeatedDateWriterImpl impl = (RepeatedDateWriterImpl)  writer.list(name).date();
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  ...
  public void read(int arrayIndex, DateHolder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
  public void read(int arrayIndex, NullableDateHolder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
