...
public class TimeStampHolderReaderImpl extends AbstractFieldReader {

  private TimeStampHolder holder;

  public TimeStampHolderReaderImpl(TimeStampHolder holder) {
    this.holder = holder;
  }
