...
public class NullableVar16CharReaderImpl extends AbstractFieldReader {
  ...
  public NullableVar16CharReaderImpl(NullableVar16CharVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(Var16CharWriter writer){
    NullableVar16CharWriterImpl impl = (NullableVar16CharWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    NullableVar16CharWriterImpl impl = (NullableVar16CharWriterImpl) writer.var16Char(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
