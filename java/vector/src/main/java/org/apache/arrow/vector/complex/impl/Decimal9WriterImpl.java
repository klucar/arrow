...
public class Decimal9WriterImpl extends AbstractFieldWriter {

  private final Decimal9Vector.Mutator mutator;
  final Decimal9Vector vector;

  public Decimal9WriterImpl(Decimal9Vector vector, AbstractFieldWriter parent) {
    super(parent);
