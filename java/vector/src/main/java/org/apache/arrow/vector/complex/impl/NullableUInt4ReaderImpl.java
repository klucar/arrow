...
public class NullableUInt4ReaderImpl extends AbstractFieldReader {
  ...
  public NullableUInt4ReaderImpl(NullableUInt4Vector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(UInt4Writer writer){
    NullableUInt4WriterImpl impl = (NullableUInt4WriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    NullableUInt4WriterImpl impl = (NullableUInt4WriterImpl) writer.uInt4(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
