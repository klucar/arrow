...
public class RepeatedUInt4HolderReaderImpl extends AbstractFieldReader {

  private NullableUInt4Holder holder;
  private int index = -1;
  private RepeatedUInt4Holder repeatedHolder;

  public RepeatedUInt4HolderReaderImpl(RepeatedUInt4Holder holder) {
