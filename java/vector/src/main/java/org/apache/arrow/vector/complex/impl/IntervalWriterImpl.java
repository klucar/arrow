...
public class IntervalWriterImpl extends AbstractFieldWriter {

  private final IntervalVector.Mutator mutator;
  final IntervalVector vector;

  public IntervalWriterImpl(IntervalVector vector, AbstractFieldWriter parent) {
    super(parent);
  ...
  public void writeInterval(int months, int days, int milliseconds) {
    mutator.setSafe(idx(), months, days, milliseconds);
    vector.getMutator().setValueCount(idx()+1);
  }
