...
public final class NullableTimeStampHolder implements ValueHolder{
  
  public static final MajorType TYPE = new MajorType(MinorType.TIMESTAMP, DataMode.OPTIONAL);
