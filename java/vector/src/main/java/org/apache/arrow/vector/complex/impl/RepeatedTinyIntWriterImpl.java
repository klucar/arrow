...
public class RepeatedTinyIntWriterImpl extends AbstractFieldWriter {

  private final RepeatedTinyIntVector.Mutator mutator;
  final RepeatedTinyIntVector vector;

  public RepeatedTinyIntWriterImpl(RepeatedTinyIntVector vector, AbstractFieldWriter parent) {
    super(parent);
