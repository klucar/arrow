...
/**
 * NullableUInt1 implements a vector of values which could be null.  Elements in the vector
...
public final class NullableUInt1Vector extends BaseDataValueVector implements FixedWidthVector, NullableVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NullableUInt1Vector.class);

  private final FieldReader reader = new NullableUInt1ReaderImpl(NullableUInt1Vector.this);
  ...
  private final UInt1Vector values = new UInt1Vector(field, allocator);

  private final Mutator mutator = new Mutator();
  private final Accessor accessor = new Accessor();

  public NullableUInt1Vector(MaterializedField field, BufferAllocator allocator) {
  ...
  @Override
  public UInt1Vector getValuesVector() {
    return values;
  }
...
//  }
  ...
  public void transferTo(NullableUInt1Vector target){
    bits.transferTo(target.bits);
    values.transferTo(target.values);
    clear();
  }

  public void splitAndTransferTo(int startIndex, int length, NullableUInt1Vector target) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new NullableUInt1Vector(field, allocator);
    }
  ...
  public UInt1Vector convertToRequiredVector(){
    UInt1Vector v = new UInt1Vector(getField().getOtherNullableVersion(), allocator);
    if (v.data != null) {
      v.data.release(1);
    }
    v.data = values.data;
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor  {
    ...
    final UInt1Vector.Accessor vAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseDataValueVector.BaseMutator implements NullableVectorDefinitionSetter {
    ...
    public UInt1Vector getVectorWithValues(){
      return values;
    }
    ...
    public void set(int index, int value) {
      setCount++;
      final UInt1Vector.Mutator valuesMutator = values.getMutator();
    ...
    public void setSkipNull(int index, UInt1Holder holder){
      values.getMutator().set(index, holder);
    }

    public void setSkipNull(int index, NullableUInt1Holder holder){
      values.getMutator().set(index, holder);
    }


    public void set(int index, NullableUInt1Holder holder){
      final UInt1Vector.Mutator valuesMutator = values.getMutator();
    ...
    public boolean isSafe(int outIndex) {
      return outIndex < NullableUInt1Vector.this.getValueCapacity();
    }
    ...
    public void setSafe(int index, NullableUInt1Holder value) {
    ...
    public void setSafe(int index, UInt1Holder value) {
