...
public final class NullableTinyIntVector extends BaseDataValueVector implements FixedWidthVector, NullableVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NullableTinyIntVector.class);

  private final FieldReader reader = new NullableTinyIntReaderImpl(NullableTinyIntVector.this);
...
//  }
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new NullableTinyIntVector(field, allocator);
    }
  ...
  public final class Mutator extends BaseDataValueVector.BaseMutator implements NullableVectorDefinitionSetter {
    ...
    public void set(int index, int value) {
      setCount++;
      final TinyIntVector.Mutator valuesMutator = values.getMutator();
