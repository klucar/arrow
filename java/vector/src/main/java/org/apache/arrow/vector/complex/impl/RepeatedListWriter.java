...
public class RepeatedListWriter extends AbstractFieldWriter {
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(RepeatedListWriter.class);
  ...
  public RepeatedListWriter(String name, RepeatedListVector container, FieldWriter parent){
    super(parent);
    this.name = name;
    this.container = container;
  }

  public RepeatedListWriter(RepeatedListVector container, FieldWriter parent){
    super(parent);
    this.name = null;
    this.container = container;
  }
