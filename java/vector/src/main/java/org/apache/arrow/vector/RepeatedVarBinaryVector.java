...
/**
 * RepeatedVarBinary implements a vector with multple values per row (e.g. JSON array or
...
public final class RepeatedVarBinaryVector extends BaseRepeatedValueVector implements RepeatedVariableWidthVectorLike {
  //private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(RepeatedVarBinaryVector.class);

  // we maintain local reference to concrete vector type for performance reasons.
  private VarBinaryVector values;
  private final FieldReader reader = new RepeatedVarBinaryReaderImpl(RepeatedVarBinaryVector.this);
  ...
  public AddOrGetResult<VarBinaryVector> addOrGetVector(VectorDescriptor descriptor) {
    final AddOrGetResult<VarBinaryVector> result = super.addOrGetVector(descriptor);
    if (result.isCreated()) {
  ...
  public void splitAndTransferTo(final int startIndex, final int groups, RepeatedVarBinaryVector to) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator) {
      this.to = new RepeatedVarBinaryVector(field, allocator);
    }
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, RepeatedVarBinaryVector.this);
    }
  }
...
//  }
  ...
  public final class Accessor extends BaseRepeatedValueVector.BaseRepeatedAccessor {
    ...
    public List<byte[]> getObject(int index) {
      ...
      final VarBinaryVector.Accessor valuesAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseRepeatedValueVector.BaseRepeatedMutator implements RepeatedMutator {
    ...
    public void setSafe(int index, RepeatedVarBinaryHolder h) {
      final VarBinaryHolder ih = new VarBinaryHolder();
      final VarBinaryVector.Accessor hVectorAccessor = h.vector.getAccessor();
