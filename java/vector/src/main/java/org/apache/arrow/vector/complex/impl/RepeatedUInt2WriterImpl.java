...
public class RepeatedUInt2WriterImpl extends AbstractFieldWriter {

  private final RepeatedUInt2Vector.Mutator mutator;
  final RepeatedUInt2Vector vector;

  public RepeatedUInt2WriterImpl(RepeatedUInt2Vector vector, AbstractFieldWriter parent) {
    super(parent);
