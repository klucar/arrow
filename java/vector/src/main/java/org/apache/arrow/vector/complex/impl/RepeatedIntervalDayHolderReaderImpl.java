...
public class RepeatedIntervalDayHolderReaderImpl extends AbstractFieldReader {

  private NullableIntervalDayHolder holder;
  private int index = -1;
  private RepeatedIntervalDayHolder repeatedHolder;

  public RepeatedIntervalDayHolderReaderImpl(RepeatedIntervalDayHolder holder) {
