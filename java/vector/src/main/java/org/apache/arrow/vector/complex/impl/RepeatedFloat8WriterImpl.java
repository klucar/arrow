...
public class RepeatedFloat8WriterImpl extends AbstractFieldWriter {

  private final RepeatedFloat8Vector.Mutator mutator;
  final RepeatedFloat8Vector vector;

  public RepeatedFloat8WriterImpl(RepeatedFloat8Vector vector, AbstractFieldWriter parent) {
    super(parent);
