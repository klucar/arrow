...
/**
 * RepeatedFloat8 implements a vector with multple values per row (e.g. JSON array or
...
public final class RepeatedFloat8Vector extends BaseRepeatedValueVector implements RepeatedFixedWidthVectorLike {
  //private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(RepeatedFloat8Vector.class);

  // we maintain local reference to concrete vector type for performance reasons.
  private Float8Vector values;
  private final FieldReader reader = new RepeatedFloat8ReaderImpl(RepeatedFloat8Vector.this);
  ...
  public AddOrGetResult<Float8Vector> addOrGetVector(VectorDescriptor descriptor) {
    final AddOrGetResult<Float8Vector> result = super.addOrGetVector(descriptor);
    if (result.isCreated()) {
  ...
  public void splitAndTransferTo(final int startIndex, final int groups, RepeatedFloat8Vector to) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, RepeatedFloat8Vector.this);
    }
  }
  ...
  public final class Accessor extends BaseRepeatedValueVector.BaseRepeatedAccessor {
    ...
    public List<Double> getObject(int index) {
      final List<Double> vals = new JsonStringArrayList<>();
      ...
      final Float8Vector.Accessor valuesAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseRepeatedValueVector.BaseRepeatedMutator implements RepeatedMutator {
    ...
    public void setSafe(int index, RepeatedFloat8Holder h) {
      final Float8Holder ih = new Float8Holder();
      final Float8Vector.Accessor hVectorAccessor = h.vector.getAccessor();
