...
public class RepeatedUInt2ReaderImpl extends AbstractFieldReader {
  ...
  public RepeatedUInt2ReaderImpl(RepeatedUInt2Vector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(UInt2Writer writer){
    RepeatedUInt2WriterImpl impl = (RepeatedUInt2WriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    RepeatedUInt2WriterImpl impl = (RepeatedUInt2WriterImpl)  writer.list(name).uInt2();
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  ...
  public void read(int arrayIndex, UInt2Holder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
  public void read(int arrayIndex, NullableUInt2Holder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
