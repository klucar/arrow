...
public class NullableVarBinaryReaderImpl extends AbstractFieldReader {
  ...
  public void copyAsValue(VarBinaryWriter writer){
    NullableVarBinaryWriterImpl impl = (NullableVarBinaryWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    NullableVarBinaryWriterImpl impl = (NullableVarBinaryWriterImpl) writer.varBinary(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
