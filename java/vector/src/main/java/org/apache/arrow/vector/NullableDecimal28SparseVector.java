...
/**
 * NullableDecimal28Sparse implements a vector of values which could be null.  Elements in the vector
...
public final class NullableDecimal28SparseVector extends BaseDataValueVector implements FixedWidthVector, NullableVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NullableDecimal28SparseVector.class);

  private final FieldReader reader = new NullableDecimal28SparseReaderImpl(NullableDecimal28SparseVector.this);
  ...
  private final Decimal28SparseVector values = new Decimal28SparseVector(field, allocator);
  ...
  @Override
  public Decimal28SparseVector getValuesVector() {
    return values;
  }
...
//  }
  ...
  public void splitAndTransferTo(int startIndex, int length, NullableDecimal28SparseVector target) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new NullableDecimal28SparseVector(field, allocator);
    }
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, NullableDecimal28SparseVector.this);
    }
  }
  ...
  public Decimal28SparseVector convertToRequiredVector(){
    Decimal28SparseVector v = new Decimal28SparseVector(getField().getOtherNullableVersion(), allocator);
    if (v.data != null) {
      v.data.release(1);
    }
    v.data = values.data;
  ...
  public void copyFrom(int fromIndex, int thisIndex, NullableDecimal28SparseVector from){
  ...
  public void copyFromSafe(int fromIndex, int thisIndex, NullableDecimal28SparseVector from){
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor  {
    ...
    final Decimal28SparseVector.Accessor vAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseDataValueVector.BaseMutator implements NullableVectorDefinitionSetter {
    ...
    public Decimal28SparseVector getVectorWithValues(){
      return values;
    }
    ...
    public void set(int index, ArrowBuf value) {
      setCount++;
      final Decimal28SparseVector.Mutator valuesMutator = values.getMutator();
    ...
    public void setSkipNull(int index, Decimal28SparseHolder holder){
      values.getMutator().set(index, holder);
    }

    public void setSkipNull(int index, NullableDecimal28SparseHolder holder){
      values.getMutator().set(index, holder);
    }


    public void set(int index, NullableDecimal28SparseHolder holder){
      final Decimal28SparseVector.Mutator valuesMutator = values.getMutator();
    ...
    public boolean isSafe(int outIndex) {
      return outIndex < NullableDecimal28SparseVector.this.getValueCapacity();
    }
    ...
    public void setSafe(int index, NullableDecimal28SparseHolder value) {
    ...
    public void setSafe(int index, Decimal28SparseHolder value) {
