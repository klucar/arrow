...
/**
 * Decimal9 implements a vector of fixed width values.  Elements in the vector are accessed
...
public final class Decimal9Vector extends BaseDataValueVector implements FixedWidthVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(Decimal9Vector.class);

  private final FieldReader reader = new Decimal9ReaderImpl(Decimal9Vector.this);
...
//    }
  ...
  private class TransferImpl implements TransferPair{
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new Decimal9Vector(field, allocator);
    }
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, Decimal9Vector.this);
    }
  }

  public void copyFrom(int fromIndex, int thisIndex, Decimal9Vector from){
 
    data.setInt(thisIndex * 4,
        from.data.getInt(fromIndex * 4)
    );
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor {
    ...
    public BigDecimal getObject(int index) {
        ...
        final BigInteger value = BigInteger.valueOf(((Integer)get(index)).intValue());
    ...
    public void get(int index, Decimal9Holder holder){
      ...
      holder.value = data.getInt(index * 4);
    }
 ...
 /**
  * Decimal9.Mutator implements a mutable vector of fixed width values.  Elements in the
