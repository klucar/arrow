...
public class RepeatedDecimal38DenseWriterImpl extends AbstractFieldWriter {
  ...
  private final RepeatedDecimal38DenseVector.Mutator mutator;
  final RepeatedDecimal38DenseVector vector;

  public RepeatedDecimal38DenseWriterImpl(RepeatedDecimal38DenseVector vector, AbstractFieldWriter parent) {
    super(parent);
