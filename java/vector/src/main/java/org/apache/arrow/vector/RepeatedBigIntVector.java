...
/**
 * RepeatedBigInt implements a vector with multple values per row (e.g. JSON array or
...
public final class RepeatedBigIntVector extends BaseRepeatedValueVector implements RepeatedFixedWidthVectorLike {
  //private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(RepeatedBigIntVector.class);

  // we maintain local reference to concrete vector type for performance reasons.
  private BigIntVector values;
  private final FieldReader reader = new RepeatedBigIntReaderImpl(RepeatedBigIntVector.this);
  ...
  public AddOrGetResult<BigIntVector> addOrGetVector(VectorDescriptor descriptor) {
    final AddOrGetResult<BigIntVector> result = super.addOrGetVector(descriptor);
    if (result.isCreated()) {
  ...
  public void splitAndTransferTo(final int startIndex, final int groups, RepeatedBigIntVector to) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, RepeatedBigIntVector.this);
    }
  }
  ...
  public final class Accessor extends BaseRepeatedValueVector.BaseRepeatedAccessor {
    ...
    public List<Long> getObject(int index) {
      ...
      final BigIntVector.Accessor valuesAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseRepeatedValueVector.BaseRepeatedMutator implements RepeatedMutator {
    ...
    public void setSafe(int index, RepeatedBigIntHolder h) {
      final BigIntHolder ih = new BigIntHolder();
      final BigIntVector.Accessor hVectorAccessor = h.vector.getAccessor();
