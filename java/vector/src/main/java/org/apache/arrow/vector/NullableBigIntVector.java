...
/**
 * NullableBigInt implements a vector of values which could be null.  Elements in the vector
...
public final class NullableBigIntVector extends BaseDataValueVector implements FixedWidthVector, NullableVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NullableBigIntVector.class);

  private final FieldReader reader = new NullableBigIntReaderImpl(NullableBigIntVector.this);
  ...
  private final BigIntVector values = new BigIntVector(field, allocator);
  ...
  @Override
  public BigIntVector getValuesVector() {
    return values;
  }
...
//  }
  ...
  public void splitAndTransferTo(int startIndex, int length, NullableBigIntVector target) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new NullableBigIntVector(field, allocator);
    }
  ...
  public BigIntVector convertToRequiredVector(){
    BigIntVector v = new BigIntVector(getField().getOtherNullableVersion(), allocator);
    if (v.data != null) {
      v.data.release(1);
    }
    v.data = values.data;
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor  {
    ...
    final BigIntVector.Accessor vAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseDataValueVector.BaseMutator implements NullableVectorDefinitionSetter {
    ...
    public BigIntVector getVectorWithValues(){
      return values;
    }
    ...
    public void set(int index, long value) {
      setCount++;
      final BigIntVector.Mutator valuesMutator = values.getMutator();
    ...
    public void setSkipNull(int index, BigIntHolder holder){
      values.getMutator().set(index, holder);
    }

    public void setSkipNull(int index, NullableBigIntHolder holder){
      values.getMutator().set(index, holder);
    }


    public void set(int index, NullableBigIntHolder holder){
      final BigIntVector.Mutator valuesMutator = values.getMutator();
    ...
    public boolean isSafe(int outIndex) {
      return outIndex < NullableBigIntVector.this.getValueCapacity();
    }
    ...
    public void setSafe(int index, NullableBigIntHolder value) {
    ...
    public void setSafe(int index, BigIntHolder value) {
