...
public class NullableDecimal38SparseWriterImpl extends AbstractFieldWriter {

  private final NullableDecimal38SparseVector.Mutator mutator;
  final NullableDecimal38SparseVector vector;

  public NullableDecimal38SparseWriterImpl(NullableDecimal38SparseVector vector, AbstractFieldWriter parent) {
    super(parent);
