...
/**
 * Time implements a vector of fixed width values.  Elements in the vector are accessed
 ...
 */
public final class TimeVector extends BaseDataValueVector implements FixedWidthVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(TimeVector.class);

  private final FieldReader reader = new TimeReaderImpl(TimeVector.this);
...
//    }
  ...
  private class TransferImpl implements TransferPair{
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new TimeVector(field, allocator);
    }
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, TimeVector.this);
    }
  }
 ...
 /**
  * Time.Mutator implements a mutable vector of fixed width values.  Elements in the
