...
/**
 * NullableTimeStamp implements a vector of values which could be null.  Elements in the vector
...
public final class NullableTimeStampVector extends BaseDataValueVector implements FixedWidthVector, NullableVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NullableTimeStampVector.class);

  private final FieldReader reader = new NullableTimeStampReaderImpl(NullableTimeStampVector.this);
  ...
  private final TimeStampVector values = new TimeStampVector(field, allocator);
...
//  }
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new NullableTimeStampVector(field, allocator);
    }
  ...
  public TimeStampVector convertToRequiredVector(){
    TimeStampVector v = new TimeStampVector(getField().getOtherNullableVersion(), allocator);
    if (v.data != null) {
      v.data.release(1);
    }
    v.data = values.data;
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor  {
    ...
    final TimeStampVector.Accessor vAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseDataValueVector.BaseMutator implements NullableVectorDefinitionSetter {
    ...
    public void set(int index, long value) {
      setCount++;
      final TimeStampVector.Mutator valuesMutator = values.getMutator();
