...
public final class NullableDecimal28SparseHolder implements ValueHolder{
  
  public static final MajorType TYPE = new MajorType(MinorType.DECIMAL28SPARSE, DataMode.OPTIONAL);
