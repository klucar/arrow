...
/**
 * NullableVarBinary implements a vector of values which could be null.  Elements in the vector
...
public final class NullableVarBinaryVector extends BaseDataValueVector implements VariableWidthVector, NullableVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NullableVarBinaryVector.class);

  private final FieldReader reader = new NullableVarBinaryReaderImpl(NullableVarBinaryVector.this);
  ...
  private final VarBinaryVector values = new VarBinaryVector(field, allocator);
...
//  }
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new NullableVarBinaryVector(field, allocator);
    }
  ...
  public VarBinaryVector convertToRequiredVector(){
    VarBinaryVector v = new VarBinaryVector(getField().getOtherNullableVersion(), allocator);
    if (v.data != null) {
      v.data.release(1);
    }
    v.data = values.data;
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor implements VariableWidthVector.VariableWidthAccessor {
    ...
    final VarBinaryVector.Accessor vAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseDataValueVector.BaseMutator implements NullableVectorDefinitionSetter, VariableWidthVector.VariableWidthMutator {
    ...
    public void set(int index, byte[] value) {
      setCount++;
      final VarBinaryVector.Mutator valuesMutator = values.getMutator();
