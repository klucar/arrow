...
public class RepeatedDecimal9ReaderImpl extends AbstractFieldReader {
  
  private final RepeatedDecimal9Vector vector;
  
  public RepeatedDecimal9ReaderImpl(RepeatedDecimal9Vector vector){
    super();
    this.vector = vector;
  }
  ...
  public void read(int arrayIndex, Decimal9Holder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
  public void read(int arrayIndex, NullableDecimal9Holder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
