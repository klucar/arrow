...
public class RepeatedDateHolderReaderImpl extends AbstractFieldReader {

  private NullableDateHolder holder;
  private int index = -1;
  private RepeatedDateHolder repeatedHolder;

  public RepeatedDateHolderReaderImpl(RepeatedDateHolder holder) {
