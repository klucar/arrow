...
/**
 * NullableDecimal38Sparse implements a vector of values which could be null.  Elements in the vector
...
public final class NullableDecimal38SparseVector extends BaseDataValueVector implements FixedWidthVector, NullableVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NullableDecimal38SparseVector.class);

  private final FieldReader reader = new NullableDecimal38SparseReaderImpl(NullableDecimal38SparseVector.this);
  ...
  private final Decimal38SparseVector values = new Decimal38SparseVector(field, allocator);
...
//  }
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new NullableDecimal38SparseVector(field, allocator);
    }
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, NullableDecimal38SparseVector.this);
    }
  }
  ...
  public Decimal38SparseVector convertToRequiredVector(){
    Decimal38SparseVector v = new Decimal38SparseVector(getField().getOtherNullableVersion(), allocator);
    if (v.data != null) {
      v.data.release(1);
    }
    v.data = values.data;
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor  {
    ...
    final Decimal38SparseVector.Accessor vAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseDataValueVector.BaseMutator implements NullableVectorDefinitionSetter {
    ...
    public void set(int index, ArrowBuf value) {
      setCount++;
      final Decimal38SparseVector.Mutator valuesMutator = values.getMutator();
