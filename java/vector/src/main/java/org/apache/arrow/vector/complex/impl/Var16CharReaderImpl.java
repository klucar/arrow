...
public class Var16CharReaderImpl extends AbstractFieldReader {
  
  private final Var16CharVector vector;
  
  public Var16CharReaderImpl(Var16CharVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(Var16CharWriter writer){
    Var16CharWriterImpl impl = (Var16CharWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    Var16CharWriterImpl impl = (Var16CharWriterImpl) writer.var16Char(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
