...
/**
 * RepeatedUInt2 implements a vector with multple values per row (e.g. JSON array or
...
public final class RepeatedUInt2Vector extends BaseRepeatedValueVector implements RepeatedFixedWidthVectorLike {
  //private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(RepeatedUInt2Vector.class);

  // we maintain local reference to concrete vector type for performance reasons.
  private UInt2Vector values;
  private final FieldReader reader = new RepeatedUInt2ReaderImpl(RepeatedUInt2Vector.this);
  ...
  public AddOrGetResult<UInt2Vector> addOrGetVector(VectorDescriptor descriptor) {
    final AddOrGetResult<UInt2Vector> result = super.addOrGetVector(descriptor);
    if (result.isCreated()) {
  ...
  public void splitAndTransferTo(final int startIndex, final int groups, RepeatedUInt2Vector to) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, RepeatedUInt2Vector.this);
    }
  }
  ...
  public final class Accessor extends BaseRepeatedValueVector.BaseRepeatedAccessor {
    ...
    public List<Character> getObject(int index) {
      final List<Character> vals = new JsonStringArrayList<>();
      ...
      final UInt2Vector.Accessor valuesAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseRepeatedValueVector.BaseRepeatedMutator implements RepeatedMutator {
    ...
    public void setSafe(int index, RepeatedUInt2Holder h) {
      final UInt2Holder ih = new UInt2Holder();
      final UInt2Vector.Accessor hVectorAccessor = h.vector.getAccessor();
