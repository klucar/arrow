...
public class RepeatedFloat8ReaderImpl extends AbstractFieldReader {
  ...
  public RepeatedFloat8ReaderImpl(RepeatedFloat8Vector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(Float8Writer writer){
    RepeatedFloat8WriterImpl impl = (RepeatedFloat8WriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    RepeatedFloat8WriterImpl impl = (RepeatedFloat8WriterImpl)  writer.list(name).float8();
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  ...
  public void read(int arrayIndex, Float8Holder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
  public void read(int arrayIndex, NullableFloat8Holder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
