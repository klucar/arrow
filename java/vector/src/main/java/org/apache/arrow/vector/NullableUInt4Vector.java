...
/**
 * NullableUInt4 implements a vector of values which could be null.  Elements in the vector
...
public final class NullableUInt4Vector extends BaseDataValueVector implements FixedWidthVector, NullableVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NullableUInt4Vector.class);

  private final FieldReader reader = new NullableUInt4ReaderImpl(NullableUInt4Vector.this);
  ...
  private final UInt4Vector values = new UInt4Vector(field, allocator);

  private final Mutator mutator = new Mutator();
  private final Accessor accessor = new Accessor();

  public NullableUInt4Vector(MaterializedField field, BufferAllocator allocator) {
  ...
  @Override
  public UInt4Vector getValuesVector() {
    return values;
  }
...
//  }
  ...
  public void transferTo(NullableUInt4Vector target){
    bits.transferTo(target.bits);
    values.transferTo(target.values);
    clear();
  }

  public void splitAndTransferTo(int startIndex, int length, NullableUInt4Vector target) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new NullableUInt4Vector(field, allocator);
    }
  ...
  public UInt4Vector convertToRequiredVector(){
    UInt4Vector v = new UInt4Vector(getField().getOtherNullableVersion(), allocator);
    if (v.data != null) {
      v.data.release(1);
    }
    v.data = values.data;
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor  {
    ...
    final UInt4Vector.Accessor vAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseDataValueVector.BaseMutator implements NullableVectorDefinitionSetter {
    ...
    public UInt4Vector getVectorWithValues(){
      return values;
    }
    ...
    public void set(int index, int value) {
      setCount++;
      final UInt4Vector.Mutator valuesMutator = values.getMutator();
    ...
    public void setSkipNull(int index, UInt4Holder holder){
      values.getMutator().set(index, holder);
    }

    public void setSkipNull(int index, NullableUInt4Holder holder){
      values.getMutator().set(index, holder);
    }


    public void set(int index, NullableUInt4Holder holder){
      final UInt4Vector.Mutator valuesMutator = values.getMutator();
    ...
    public boolean isSafe(int outIndex) {
      return outIndex < NullableUInt4Vector.this.getValueCapacity();
    }
    ...
    public void setSafe(int index, NullableUInt4Holder value) {
    ...
    public void setSafe(int index, UInt4Holder value) {
