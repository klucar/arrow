...
public class RepeatedTimeWriterImpl extends AbstractFieldWriter {

  private final RepeatedTimeVector.Mutator mutator;
  final RepeatedTimeVector vector;

  public RepeatedTimeWriterImpl(RepeatedTimeVector vector, AbstractFieldWriter parent) {
    super(parent);
