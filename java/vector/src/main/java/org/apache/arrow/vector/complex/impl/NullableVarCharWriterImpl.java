...
public class NullableVarCharWriterImpl extends AbstractFieldWriter {

  private final NullableVarCharVector.Mutator mutator;
  final NullableVarCharVector vector;

  public NullableVarCharWriterImpl(NullableVarCharVector vector, AbstractFieldWriter parent) {
    super(parent);
