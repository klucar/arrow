...
public final class Decimal28DenseHolder implements ValueHolder{
  
  public static final MajorType TYPE = new MajorType(MinorType.DECIMAL28DENSE, DataMode.REQUIRED);
