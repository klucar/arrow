...
/**
 * TimeStamp implements a vector of fixed width values.  Elements in the vector are accessed
 ...
 */
public final class TimeStampVector extends BaseDataValueVector implements FixedWidthVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(TimeStampVector.class);

  private final FieldReader reader = new TimeStampReaderImpl(TimeStampVector.this);
  ...
  public TimeStampVector(MaterializedField field, BufferAllocator allocator) {
...
//    }
  ...
  public void transferTo(TimeStampVector target){
    target.clear();
  ...
  public void splitAndTransferTo(int startIndex, int length, TimeStampVector target) {
  ...
  private class TransferImpl implements TransferPair{
    private TimeStampVector to;

    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new TimeStampVector(field, allocator);
    }
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor {
    ...
    public void get(int index, TimeStampHolder holder){
 ...
 /**
  * TimeStamp.Mutator implements a mutable vector of fixed width values.  Elements in the
  ...
  */
  public final class Mutator extends BaseDataValueVector.BaseMutator {
   ...
   protected void set(int index, TimeStampHolder holder){
   ...
   protected void set(int index, NullableTimeStampHolder holder){
     data.setLong(index * 8, holder.value);
   }
