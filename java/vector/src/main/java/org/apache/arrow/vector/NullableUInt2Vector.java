...
/**
 * NullableUInt2 implements a vector of values which could be null.  Elements in the vector
...
public final class NullableUInt2Vector extends BaseDataValueVector implements FixedWidthVector, NullableVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NullableUInt2Vector.class);

  private final FieldReader reader = new NullableUInt2ReaderImpl(NullableUInt2Vector.this);
  ...
  private final UInt2Vector values = new UInt2Vector(field, allocator);
...
//  }
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new NullableUInt2Vector(field, allocator);
    }
  ...
  public UInt2Vector convertToRequiredVector(){
    UInt2Vector v = new UInt2Vector(getField().getOtherNullableVersion(), allocator);
    if (v.data != null) {
      v.data.release(1);
    }
    v.data = values.data;
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor  {
    ...
    final UInt2Vector.Accessor vAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseDataValueVector.BaseMutator implements NullableVectorDefinitionSetter {
    ...
    public void set(int index, int value) {
      setCount++;
      final UInt2Vector.Mutator valuesMutator = values.getMutator();
