...
public class RepeatedUInt1ReaderImpl extends AbstractFieldReader {
  
  private final RepeatedUInt1Vector vector;
  
  public RepeatedUInt1ReaderImpl(RepeatedUInt1Vector vector){
    super();
    this.vector = vector;
  }
  ...
  public void read(int arrayIndex, UInt1Holder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
  public void read(int arrayIndex, NullableUInt1Holder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
