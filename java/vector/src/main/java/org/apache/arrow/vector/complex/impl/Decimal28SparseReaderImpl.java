...
public class Decimal28SparseReaderImpl extends AbstractFieldReader {
  
  private final Decimal28SparseVector vector;
  
  public Decimal28SparseReaderImpl(Decimal28SparseVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(Decimal28SparseWriter writer){
    Decimal28SparseWriterImpl impl = (Decimal28SparseWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    Decimal28SparseWriterImpl impl = (Decimal28SparseWriterImpl) writer.decimal28Sparse(name);
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
