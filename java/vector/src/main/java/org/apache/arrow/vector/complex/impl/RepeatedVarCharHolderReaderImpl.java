...
public class RepeatedVarCharHolderReaderImpl extends AbstractFieldReader {

  private NullableVarCharHolder holder;
  private int index = -1;
  private RepeatedVarCharHolder repeatedHolder;

  public RepeatedVarCharHolderReaderImpl(RepeatedVarCharHolder holder) {
  ...
  @Override
  public Text readText(int index){
    repeatedHolder.vector.getAccessor().get(repeatedHolder.start + index, holder);
    Text value = readText();
    if (this.index > -1) {
