...
public class RepeatedVar16CharReaderImpl extends AbstractFieldReader {
  ...
  public RepeatedVar16CharReaderImpl(RepeatedVar16CharVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(Var16CharWriter writer){
    RepeatedVar16CharWriterImpl impl = (RepeatedVar16CharWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    RepeatedVar16CharWriterImpl impl = (RepeatedVar16CharWriterImpl)  writer.list(name).var16Char();
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  ...
  public void read(int arrayIndex, Var16CharHolder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
  public void read(int arrayIndex, NullableVar16CharHolder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
