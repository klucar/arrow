...
/**
 * Decimal28Dense implements a vector of fixed width values.  Elements in the vector are accessed
 ...
 */
public final class Decimal28DenseVector extends BaseDataValueVector implements FixedWidthVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(Decimal28DenseVector.class);

  private final FieldReader reader = new Decimal28DenseReaderImpl(Decimal28DenseVector.this);
...
//    }
  ...
  private class TransferImpl implements TransferPair{
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new Decimal28DenseVector(field, allocator);
    }
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, Decimal28DenseVector.this);
    }
  }
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor {
    ...
    public void get(int index, NullableDecimal28DenseHolder holder) {
      ...
      return org.apache.arrow.vector.util.DecimalUtility.getBigDecimalFromDense(data, index * 12, 3, getField().getScale(), 28, 12);
    }
 ...
 /**
  * Decimal28Dense.Mutator implements a mutable vector of fixed width values.  Elements in the
  ...
  */
  public final class Mutator extends BaseDataValueVector.BaseMutator {
   ...
   public void set(int index, int start, ArrowBuf buffer){
     data.setBytes(index * 12, buffer, start, 12);
   }
