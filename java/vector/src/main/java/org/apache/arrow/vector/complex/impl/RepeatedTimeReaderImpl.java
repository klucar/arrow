...
public class RepeatedTimeReaderImpl extends AbstractFieldReader {
  
  private final RepeatedTimeVector vector;
  
  public RepeatedTimeReaderImpl(RepeatedTimeVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(TimeWriter writer){
    RepeatedTimeWriterImpl impl = (RepeatedTimeWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    RepeatedTimeWriterImpl impl = (RepeatedTimeWriterImpl)  writer.list(name).time();
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  ...
  public void read(int arrayIndex, TimeHolder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
  public void read(int arrayIndex, NullableTimeHolder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
