...
/**
 * UInt1 implements a vector of fixed width values.  Elements in the vector are accessed
 ...
 */
public final class UInt1Vector extends BaseDataValueVector implements FixedWidthVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(UInt1Vector.class);

  private final FieldReader reader = new UInt1ReaderImpl(UInt1Vector.this);
...
//    }
 ...
 /**
  * UInt1.Mutator implements a mutable vector of fixed width values.  Elements in the
