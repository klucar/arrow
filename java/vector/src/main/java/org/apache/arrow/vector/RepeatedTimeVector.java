...
/**
 * RepeatedTime implements a vector with multple values per row (e.g. JSON array or
...
public final class RepeatedTimeVector extends BaseRepeatedValueVector implements RepeatedFixedWidthVectorLike {
  //private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(RepeatedTimeVector.class);

  // we maintain local reference to concrete vector type for performance reasons.
  private TimeVector values;
  private final FieldReader reader = new RepeatedTimeReaderImpl(RepeatedTimeVector.this);
  ...
  public AddOrGetResult<TimeVector> addOrGetVector(VectorDescriptor descriptor) {
    final AddOrGetResult<TimeVector> result = super.addOrGetVector(descriptor);
    if (result.isCreated()) {
  ...
  public void splitAndTransferTo(final int startIndex, final int groups, RepeatedTimeVector to) {
  ...
  private class TransferImpl implements TransferPair {
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, RepeatedTimeVector.this);
    }
  }
  ...
  public final class Accessor extends BaseRepeatedValueVector.BaseRepeatedAccessor {
    ...
    public List<DateTime> getObject(int index) {
      ...
      final TimeVector.Accessor valuesAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseRepeatedValueVector.BaseRepeatedMutator implements RepeatedMutator {
    ...
    public void setSafe(int index, RepeatedTimeHolder h) {
      final TimeHolder ih = new TimeHolder();
      final TimeVector.Accessor hVectorAccessor = h.vector.getAccessor();
