...
public class RepeatedBigIntReaderImpl extends AbstractFieldReader {
  ...
  public RepeatedBigIntReaderImpl(RepeatedBigIntVector vector){
    super();
    this.vector = vector;
  }
  ...
  public void copyAsValue(BigIntWriter writer){
    RepeatedBigIntWriterImpl impl = (RepeatedBigIntWriterImpl) writer;
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  
  public void copyAsField(String name, MapWriter writer){
    RepeatedBigIntWriterImpl impl = (RepeatedBigIntWriterImpl)  writer.list(name).bigInt();
    impl.vector.copyFromSafe(idx(), impl.idx(), vector);
  }
  ...
  public void read(int arrayIndex, BigIntHolder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
  public void read(int arrayIndex, NullableBigIntHolder h){
    vector.getAccessor().get(idx(), arrayIndex, h);
  }
