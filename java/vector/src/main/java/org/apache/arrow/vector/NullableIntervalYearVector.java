...
/**
 * NullableIntervalYear implements a vector of values which could be null.  Elements in the vector
...
public final class NullableIntervalYearVector extends BaseDataValueVector implements FixedWidthVector, NullableVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NullableIntervalYearVector.class);

  private final FieldReader reader = new NullableIntervalYearReaderImpl(NullableIntervalYearVector.this);
  ...
  private final IntervalYearVector values = new IntervalYearVector(field, allocator);
...
//  }
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new NullableIntervalYearVector(field, allocator);
    }
  ...
  public IntervalYearVector convertToRequiredVector(){
    IntervalYearVector v = new IntervalYearVector(getField().getOtherNullableVersion(), allocator);
    if (v.data != null) {
      v.data.release(1);
    }
    v.data = values.data;
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor  {
    ...
    final IntervalYearVector.Accessor vAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseDataValueVector.BaseMutator implements NullableVectorDefinitionSetter {
    ...
    public void set(int index, int value) {
      setCount++;
      final IntervalYearVector.Mutator valuesMutator = values.getMutator();
