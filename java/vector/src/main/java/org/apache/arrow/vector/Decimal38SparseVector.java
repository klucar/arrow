...
/**
 * Decimal38Sparse implements a vector of fixed width values.  Elements in the vector are accessed
 ...
 *   The width of each element is 24 byte(s)
 ...
 */
public final class Decimal38SparseVector extends BaseDataValueVector implements FixedWidthVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(Decimal38SparseVector.class);

  private final FieldReader reader = new Decimal38SparseReaderImpl(Decimal38SparseVector.this);
  private final Accessor accessor = new Accessor();
  private final Mutator mutator = new Mutator();

  private int allocationSizeInBytes = INITIAL_VALUE_ALLOCATION * 24;
  ...
  public int getValueCapacity(){
    return (int) (data.capacity() *1.0 / 24);
  }
  ...
  public void setInitialCapacity(final int valueCount) {
    final long size = 1L * valueCount * 24;
...
//    final int expectedLength = valueCount * 24;
...
//    }
  ...
  public void splitAndTransferTo(int startIndex, int length, Decimal38SparseVector target) {
    final int startPoint = startIndex * 24;
    final int sliceLength = length * 24;
    target.clear();
  ...
  private class TransferImpl implements TransferPair{
    ...
    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new Decimal38SparseVector(field, allocator);
    }
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, Decimal38SparseVector.this);
    }
  }

  public void copyFrom(int fromIndex, int thisIndex, Decimal38SparseVector from){
    from.data.getBytes(fromIndex * 24, data, thisIndex * 24, 24);
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor {
    ...
    public void get(int index, NullableDecimal38SparseHolder holder) {
      ...
      return org.apache.arrow.vector.util.DecimalUtility.getBigDecimalFromSparse(data, index * 24, 6, getField().getScale());
    }
 ...
 /**
  * Decimal38Sparse.Mutator implements a mutable vector of fixed width values.  Elements in the
  ...
  */
  public final class Mutator extends BaseDataValueVector.BaseMutator {
   ...
   public void set(int index, ArrowBuf value) {
     data.setBytes(index * 24, value, 0, 24);
   }
   ...
   public void set(int index, int start, ArrowBuf buffer){
     data.setBytes(index * 24, buffer, start, 24);
   }
   ...
   public void setValueCount(int valueCount) {
     ...
     data.writerIndex(valueCount * 24);
   }
 }
}
