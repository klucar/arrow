...
/**
 * NullableDecimal28Dense implements a vector of values which could be null.  Elements in the vector
...
public final class NullableDecimal28DenseVector extends BaseDataValueVector implements FixedWidthVector, NullableVector{
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NullableDecimal28DenseVector.class);

  private final FieldReader reader = new NullableDecimal28DenseReaderImpl(NullableDecimal28DenseVector.this);
  ...
  private final Decimal28DenseVector values = new Decimal28DenseVector(field, allocator);

  private final Mutator mutator = new Mutator();
  private final Accessor accessor = new Accessor();

  public NullableDecimal28DenseVector(MaterializedField field, BufferAllocator allocator) {
  ...
  @Override
  public Decimal28DenseVector getValuesVector() {
    return values;
  }
...
//  }
  ...
  public TransferPair makeTransferPair(ValueVector to) {
    return new TransferImpl((NullableDecimal28DenseVector) to);
  }

  public void transferTo(NullableDecimal28DenseVector target){
    bits.transferTo(target.bits);
    values.transferTo(target.values);
    clear();
  }

  public void splitAndTransferTo(int startIndex, int length, NullableDecimal28DenseVector target) {
    bits.splitAndTransferTo(startIndex, length, target.bits);
    values.splitAndTransferTo(startIndex, length, target.values);
  }

  private class TransferImpl implements TransferPair {
    NullableDecimal28DenseVector to;

    public TransferImpl(MaterializedField field, BufferAllocator allocator){
      to = new NullableDecimal28DenseVector(field, allocator);
    }

    public TransferImpl(NullableDecimal28DenseVector to){
      this.to = to;
    }

    @Override
    public NullableDecimal28DenseVector getTo(){
      return to;
    }
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, NullableDecimal28DenseVector.this);
    }
  }
  ...
  public Decimal28DenseVector convertToRequiredVector(){
    Decimal28DenseVector v = new Decimal28DenseVector(getField().getOtherNullableVersion(), allocator);
    if (v.data != null) {
      v.data.release(1);
    }
    v.data = values.data;
  ...
  public void copyFrom(int fromIndex, int thisIndex, NullableDecimal28DenseVector from){
  ...
  public void copyFromSafe(int fromIndex, int thisIndex, NullableDecimal28DenseVector from){
  ...
  public final class Accessor extends BaseDataValueVector.BaseAccessor  {
    ...
    final Decimal28DenseVector.Accessor vAccessor = values.getAccessor();
  ...
  public final class Mutator extends BaseDataValueVector.BaseMutator implements NullableVectorDefinitionSetter {
    ...
    public Decimal28DenseVector getVectorWithValues(){
      return values;
    }
    ...
    public void set(int index, ArrowBuf value) {
      setCount++;
      final Decimal28DenseVector.Mutator valuesMutator = values.getMutator();
    ...
    public void setSkipNull(int index, Decimal28DenseHolder holder){
      values.getMutator().set(index, holder);
    }

    public void setSkipNull(int index, NullableDecimal28DenseHolder holder){
      values.getMutator().set(index, holder);
    }


    public void set(int index, NullableDecimal28DenseHolder holder){
      final Decimal28DenseVector.Mutator valuesMutator = values.getMutator();
    ...
    public boolean isSafe(int outIndex) {
      return outIndex < NullableDecimal28DenseVector.this.getValueCapacity();
    }
    ...
    public void setSafe(int index, NullableDecimal28DenseHolder value) {
    ...
    public void setSafe(int index, Decimal28DenseHolder value) {
